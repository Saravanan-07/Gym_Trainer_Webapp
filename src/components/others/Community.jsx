...
import '../../assets/css/others/Community.css'; // Assume there's a corresponding CSS file for styling
import jogimg from '../../assets/images/homepage/Walkingimg.jpeg'
import milimg from '../../assets/images/homepage/Joggingimg.jpeg'
const App = () => {
  return (
    <div className="app">
